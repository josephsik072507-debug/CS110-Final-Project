...
class Game:
    def __init__(self):
        ...
        pygame.mixer.music.load("portfolio/ch09/final/graphics/music.wav") 
        pygame.mixer.music.play(-1,0.0)
        self.SCREEN_UPDATE = pygame.USEREVENT
        pygame.time.set_timer(self.SCREEN_UPDATE,150)

        fruit_image = pygame.image.load('portfolio/ch09/final/graphics/strawberry4.png').convert_alpha()
        fruit_image = pygame.transform.scale(fruit_image,(40,40))
        snake_image = pygame.image.load('portfolio/ch09/final/graphics/snake_body.png').convert_alpha()
        snake_image = pygame.transform.scale(snake_image,(40,40))
        font = pygame.font.Font("portfolio/ch09/final/graphics/PressStart2P-Regular.ttf",25)
